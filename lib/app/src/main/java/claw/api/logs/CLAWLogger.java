...
public class CLAWLogger {
    ...
    private static LoggerDomain rootLoggerDomain = new LoggerDomain();
    ...
    private static void addData (LogData data) {
        if (rootLoggerDomain.doesDomainPathExist(data.logDomain)) {
    ...
    public static void addDomainPath (String domainPath) throws InvalidDomainPathException {
        rootLoggerDomain.addDomainPath(domainPath);
    }
    
    public static void clearWatchingLoggerDomains () {
    ...
    public static class InvalidDomainPathException extends Exception {
        public InvalidDomainPathException () {
            super("Invalid domain path.");
        }
    }
